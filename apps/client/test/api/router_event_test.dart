...
void main() {
  group('RouterModelEvent.fromJson (llama.cpp\'s own shape, not a Nelle envelope)', () {
    ...
    test('a frame that names no model is dropped, not guessed at', () {
      expect(RouterModelEvent.fromJson(<String, dynamic>{'data': {}}), isNull);
      expect(RouterModelEvent.fromJson(<String, dynamic>{'model': ''}), isNull);
    });
