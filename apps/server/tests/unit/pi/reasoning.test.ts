...
} from '../../../src/contracts/reasoning.ts';
import {templateSupportsThinking} from '../../../src/contracts/reasoning.ts';
import {reasoningBudgetsFromSettings, SETTINGS_REGISTRY} from '../../../src/contracts/settings.ts';
import {REASONING_SETTINGS_SLUG} from '../../../src/contracts/settingsKeys.ts';
